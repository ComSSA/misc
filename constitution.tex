...
\begin{enumerate}[a)]
	\item The OCM's suspension must be included in the agenda of the aforementioned meeting.
	...
	\begin{enumerate}[i)]
		\item At least one Committee Member may request that the suspended OCM be removed from the meeting during discussion.
		\item At least two Committee Members may request that the suspended OCM be removed from the meeting during the vote.
	\end{enumerate}
\end{enumerate}
...
\begin{enumerate}[a)]
	...
	\begin{enumerate}[i)]
		\item At least one Committee Member may request that the OCM in question be removed from the meeting during discussion.
...
\begin{enumerate}[a)]
	...
	\begin{enumerate}[i)]
		\item At least one Committee Member may request that the removed OCM be removed from the meeting during discussion.
		\item At least two Committee Members may request that the removed OCM be removed from the meeting during the vote.
	\end{enumerate}
...
\begin{enumerate}[a)]
	...
	\begin{enumerate}[i)]
		\item At least one Committee Member may request that the Executive Committee Member in question be removed from the meeting during discussion.
