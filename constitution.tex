...
\begin{enumerate}[a)]
	...
	\begin{enumerate}[i)]
		...
		\item The Nominee must be studying at least one of the following courses which yield at least one Computing degree upon graduation:
		\begin{itemize}
			\item 151099 --- BSc (Computer Science),
			\item 143010 --- BSc (Information Technology),
			\item 309909 --- BSc (Software Engineering),
			\item 313312 --- BSc (Computing),
			\item 313799 --- BSc (Science) Computing Pre-major,
			\item 313313 --- BSc (Science) Computing Major,
			\item 305670 --- BTech (Computer Systems and Networking),
			\item 313605 --- BEng Software Engineering Major,
			\item 132010 --- BEng (Computer Systems Engineering), \\ BSc (Computer Science),
			\item 132210 --- BEng (Electronic and Communication Engineering), \\ BSc (Computer Science),
			\item 310845 --- BSc (Honours) Computer Science Major,
			\item 310861 --- MSc (Science) Computer Science Major,
			\item 190303 --- MPhil (Computer Science), or
			\item 198902 --- PhD - Computing.
		\end{itemize}
	\end{enumerate}
\end{enumerate}
