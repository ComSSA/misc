...
\begin{enumerate}[a)]
	\item Ordinary Committee Members can be removed from their position via an Absolute Majority vote by the Committee, with the exception of the OCM being considered for removal.
...
\begin{enumerate}[a)]
	\item The request for suspension must be included in the agenda of the aforementioned meeting.
...
\begin{enumerate}[a)]
	\item The request includes reasons for removal from office, and
	\item The request includes the signatures of at least twenty (20) members or an Absolute Majority of the listed Members, whichever is fewer.
\end{enumerate}
...
\begin{enumerate}[a)]
	...
	\item Any matter that is voted upon shall be deemed to be passed via a Simple Majority of the Members.
\end{enumerate}
