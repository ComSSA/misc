...
\begin{enumerate}[a)]
	...
	\item Suspension will be confirmed by a majority vote by the Committee, that being 50\% + 1 of the full Committee, with the exception of the suspended OCM.
	\begin{enumerate}[i)]
...
\begin{enumerate}[a)]
	...
	\item A majority vote by the Committee, that being 50\% + 1 of the full Committee, with the exception of the OCM being considered for removal:
	\begin{enumerate}[i)]
...
\begin{enumerate}[a)]
	...
	\item The OCM will be restored to their position upon majority vote by the Committee, that being 50\% + 1 of the full Committee.
	\begin{enumerate}[i)]
...
\begin{enumerate}[a)]
	...
	\item The executive member will be removed from their position upon majority vote by the Committee, that being 50\% + 1 of the full Committee, with the exception of the executive member being considered for removal.
	\begin{enumerate}[i)]
...
Quorum for an SGM shall be twenty (20) members or 50\% of the listed members, whichever is less.
